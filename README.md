...
<details>
  <summary>10) Сифон для ванны AlcaPlast click/clack с плоским переливом. Сифон со встроенным фитингом, что позволяет подключить шланг с водой и наполнять ванну водой (в пути)</summary>
...
10) Сифон для ванны AlcaPlast click/clack с плоским переливом 1шт. - 5090 руб.
